                        ...
                        <ul className="md:max-w-xs">
                          <li className="mb-5 flex flex-wrap">
                            <span className="flex-1 font-medium leading-relaxed">
                              Utilisez cet outil facilement, avec une multitude
                              de modèle. Il est désormais facile de créer le
                              parfait questionnaire !
                            </span>
                          </li>
                          <li className="mb-5 flex flex-wrap">
                            <span className="flex-1 font-medium leading-relaxed">
                  ...
                  >
                    {({ errors, touched }) => (
                      <Form className="md:max-w-lg mx-auto">
                        ...
                        <button className="flex items-center p-2 md:p-4 space-x-2 bg-white hover:bg-gray-50 border rounded-lg transition ease-in-out duration-200 text-sm md:text-base w-full">
                          <GoRocket className="text-neutral h-auto w-3" />
